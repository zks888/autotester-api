...
class CodeGenerator {
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/admin_test?useUnicode=true&characterEncoding=utf-8&useLegacyDatetimeCode=false&serverTimezone=UTC";
    ...
    // 模板位置
    private static final String TEMPLATE_FILE_PATH = CodeGenerator.PROJECT_PATH + "/slaverservice/src/test/resources/generator/template";
    // java文件路径
