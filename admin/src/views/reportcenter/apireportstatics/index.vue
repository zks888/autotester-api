<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="searchcase" ref="searchcase">
        <span v-if="hasPermission('apireportstatics:search')">
          ...
          <el-form-item label="测试任务" prop="testplanname" required>
            <el-select v-model="searchcase.testplanname" placeholder="测试任务" @change="testplanselectChanged($event)">
        ...
        <el-form-item label="执行测试任务" prop="batchname" requied >
          <el-select v-model="searchcase.batchname" placeholder="执行测试任务">
            <el-option label="请选择" value=""/>
    ...
    >
      ...
      <el-table-column label="测试任务" align="center" prop="planname" width="200"/>
      <el-table-column label="执行测试任务" align="center" prop="batchname" width="200"/>
  ...
  methods: {
    ...
    testplanselectChanged(e) {
      ...
      getbatchbyplan(this.tmpapireportstatics).then(response => {
        ...
        this.$message.error('加载执行测试任务列表失败')
      })
    },
