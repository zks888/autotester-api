        ...
        for (Slaver slaver : SlaverList) {
            if (!slaver.getStatus().equalsIgnoreCase("已下线")) {
                ...
                try {
                    ...
                    log.info("调度服务检查功能Slaver检测：" + ServerUrl + "请求响应结果。。。。。。。。。。。。。。。。。。。。。。。。：" + respon);
                } catch (Exception e) {
                    //1.置为已下线
                    slaverMapper.updateSlaverStatus(slaver.getId(), "已下线");
                    log.info("调度服务检查功能Slaver "+slaver.getSlavername() + "检测结果为下线：" + ServerUrl + "请求响应结果异常。。。。。。。。。。。。。。。。。。。。。。。。：" + e.getMessage());
                    //补偿
    ...
    public List<Slaver> GetAllAliveSlaver() {
        ...
        for (Slaver slaver : slaverlist) {
            ...
            try {
                ...
                log.info("调度服务检查功能Slaver检测GetAliveSlaver：" + ServerUrl + "请求响应结果。。。。。。。。。。。。。。。。。。。。。。。。：" + respon);
            } catch (Exception e) {
                log.info("调度服务检查功能Slaver检测GetAliveSlaver：" + ServerUrl + "请求响应结果。。。。。。。。。。。。。。。。。。。。。。。。：" + e.getMessage());
                slaverMapper.updateSlaverStatus(slaver.getId(), "已下线");
            }
        }
