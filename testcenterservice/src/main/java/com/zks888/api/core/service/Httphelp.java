package com.zks888.api.core.service;
...
public class Httphelp {
    ...
    public static TestResponeData PostWithUrlParams(String protocal, String url, String postdata, String requestcontenttype, HttpHeader header, int connectTimeout, int readTimeout) throws Exception {
        ...
        try {
            ...
            for (Header header1 : httpPost.getAllHeaders()) {
                log.info("..................Post请求Header名 :  " + header1.getName() + "  Header值：" + header1.getValue());
            }
            log.info("..................Post请求数据 :  " + query);
            ...
            log.info("Get Exception is :" + e.getMessage());
        ...
        log.info("Post 请求响应 is :" + testResponeData.getResponeContent());
    ...
    public static TestResponeData PostWithBody(String Protocal, String Url, String Postdata, HttpHeader header, int connectTimeout) throws Exception {
        ...
        try {
            ...
            log.info("Post PostWithBody..................Post请求地址 :  " + Url);
            for (Header header1 : httpPost.getAllHeaders()) {
                log.info("..................Post请求Header名 :  " + header1.getName() + "  Header值：" + header1.getValue());
            }
            log.info("Post PostWithBody..................Post开始请求数据 :  " + Query);
            httpResponse = httpClient.execute(httpPost);
            log.info("Post PostWithBody..................Post结束请求");
            if (cookieStore != null) {
                List<Cookie> cookies = cookieStore.getCookies();
                if (cookies.size() > 0) {
                    testResponeData.setCookies(cookies);
                    log.info("Post PostWithBody..................Post setCookies结束");
                }
            }
            if (httpResponse != null) {
                testResponeData = GetResponeData(httpResponse);
                log.info("Post PostWithBody..................Post GetResponeData结束");
            }
        } catch (Exception e) {
            log.info("Post PostWithBody Exception is :" + e.getMessage());
            throw new Exception("请求地址:" + Url + " 发生异常，原因：" + e.getMessage());
        } finally {
            if (httpResponse != null) {
                httpResponse.close();
        ...
        log.info("Post PostWithBody 请求响应 is :" + testResponeData.getResponeContent());
        return testResponeData;
    }
    ...
    public static TestResponeData GetWithBody(String Protocal, String Url, String PostData, HttpHeader header, int connectTimeout) throws Exception {
        ...
        try {
            ...
            log.info("Httphelp..................doGetWithBody请求地址 :  " + Url);
            for (Header header1 : httpGetWithEntity.getAllHeaders()) {
                log.info("Httphelp..................doGetWithBody请求Header名 :  " + header1.getName() + "  Header值：" + header1.getValue());
            }
            ...
            log.info("Httphelp doGetWithBody Exception is :" + e.getMessage());
            throw new Exception("请求地址:" + Url + " 发生异常，原因：" + e.getMessage());
        } finally {
            if (httpResponse != null) {
                httpResponse.close();
        ...
        log.info("doGetWithBody请求响应 :" + testResponeData.getResponeContent());
        return testResponeData;
    }
    ...
    public static TestResponeData GetWithNoParams(String protocal, String url, HttpHeader header, int connectTimeout) throws Exception {
        ...
        try {
            ...
            log.info("Httphelp..................GetWithNoParams请求地址 :  " + url);
            for (Header header1 : httpGet.getAllHeaders()) {
                log.info("Httphelp..................GetWithNoParams请求Header名 :  " + header1.getName() + "  Header值：" + header1.getValue());
            }
            ...
            log.info("Httphelp GetWithNoParams Exception is :" + e.getMessage());
            throw new Exception("请求地址:" + url + " 发生异常，原因：" + e.getMessage());
        } finally {
            if (httpResponse != null) {
                httpResponse.close();
        ...
        log.info("Httphelp GetWithNoParams请求响应 :" + testResponeData.getResponeContent());
        return testResponeData;
    }
    ...
    public static TestResponeData doGet(String protocal, String url, String PostData, String requestcontenttype, HttpHeader header, int connectTimeout, int readTimeout) throws Exception {
        ...
        try {
            ...
            log.info("Httphelp..................Get请求地址 :  " + url);
            for (Header header1 : httpGet.getAllHeaders()) {
                log.info("Httphelp..................Get请求Header名 :  " + header1.getName() + "  Header值：" + header1.getValue());
            }
            ...
            log.info("Httphelp Get Exception is :" + e.getMessage());
            throw new Exception("请求地址:" + url + " 发生异常，原因：" + e.getMessage());
        } finally {
            if (httpResponse != null) {
                httpResponse.close();
        ...
        log.info("Httphelp Get请求响应 :" + testResponeData.getResponeContent());
        return testResponeData;
    }
    ...
    public static TestResponeData doPut(String protocal, String url, String PostData, HttpHeader header, int connectTimeout) throws Exception {
        ...
        try {
            ...
            log.info("Httphelp..................Put请求地址 :  " + url);
            for (Header header1 : httpPut.getAllHeaders()) {
                log.info("..................Put请求Header名 :  " + header1.getName() + "  Header值：" + header1.getValue());
            }
            log.info("Httphelp..................Put请求数据 :  " + query);
            ...
            log.info("Httphelp Put Exception is :" + e.getMessage());
            throw new Exception("请求地址:" + url + " 发生异常，原因：" + e.getMessage());
        } finally {
            if (httpResponse != null) {
                httpResponse.close();
        ...
        log.info("Httphelp Put responseData is :" + testResponeData.getResponeContent());
        return testResponeData;
    }
    ...
    public static TestResponeData doDelete(String protocal, String url, String PostData, HttpHeader header, int connectTimeout) throws Exception {
        ...
        try {
            ...
            log.info("Httphelp..................Delete请求地址 :  " + url);
            for (Header header1 : httpDelete.getAllHeaders()) {
                log.info("Httphelp..................Delete请求Header名 :  " + header1.getName() + "  Header值：" + header1.getValue());
            }
            log.info("Httphelp..................Delete请求数据 :  " + query);
            httpResponse = httpClient.execute(httpDelete);
            List<Cookie> cookies = cookieStore.getCookies();
            testResponeData.setCookies(cookies);
            testResponeData = GetResponeData(httpResponse);
        } catch (Exception e) {
            log.info("Httphelp Delete Exception is :" + e.getMessage());
            throw new Exception("请求地址:" + url + " 发生异常，原因：" + e.getMessage());
        } finally {
            if (httpResponse != null) {
                httpResponse.close();
        ...
        log.info("Delete响应 is :" + testResponeData.getResponeContent());
        return testResponeData;
    }
        ...
        if (header != null) {
            ...
            if (headerMap != null && !headerMap.isEmpty()) {
                ...
                for (Map.Entry<String, Object> entry : entries) {
                    ...
                    log.info("Httphelp header name is :  " + name + " value is :  " + value);
    ...
    private static String buildGetUrl(String url, String query) {
        ...
        newUrl.append(query);
        log.info("buildGetUrl url is :  " + newUrl.toString());
