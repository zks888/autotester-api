...
@Table(name = "testcondition_report")
public class TestconditionReport {
    ...
    /**
     * 获取子条件id，接口，db，nosql条件id
     *
     * @return subconditionid - 子条件id，接口，db，nosql条件id
     */
    ...
    /**
     * 设置子条件id，接口，db，nosql条件id
     *
     * @param subconditionid 子条件id，接口，db，nosql条件id
     */
