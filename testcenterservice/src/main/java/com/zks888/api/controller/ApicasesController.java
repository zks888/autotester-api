...
import com.zks888.api.core.service.*;
import com.zks888.api.dto.*;
import com.zks888.api.entity.*;
import com.zks888.api.service.*;
import com.zks888.api.util.RadomVariables;
...
public class ApicasesController {
    ...
    public Result search(@RequestBody final Map<String, Object> param) {
        ...
        PageHelper.startPage(page, size);
        final List<Apicases> list = apicasesService.findApiCaseWithName(param);
    ...
    public Result searchleftcase(@RequestBody final Map<String, Object> param) {
        ...
        int size = Integer.parseInt(param.get("size").toString());
        PageHelper.startPage(page, size);
        final List<Apicases> list = apicasesService.findApiCaseleft(param);
        final PageInfo<Apicases> pageInfo = new PageInfo<>(list);
        return ResultGenerator.genOkResult(pageInfo);
    }
    ...
    public Result getcasebydeployunitid(@RequestBody final Map<String, Object> param) {
        ...
        final List<Apicases> list = apicasesService.getcasebydeployunitid(Long.parseLong(deployunitid));
    ...
    public Result searchbyname(@RequestBody final Map<String, Object> param) {
        ...
        final List<Apicases> list = apicasesService.getapicasebyName(deployunitid, apiid);
        return ResultGenerator.genOkResult(list);
    }
    ...
    public Result runtest(@RequestBody final Map<String, Object> param) {
        ...
        if (prixflag) {
            ...
            if (apicasesDebugCondition != null) {
                try {
                    ...
                    GetResponeMap(APIRespone, ParamsValuesMap);
                    DBRespone = conditionResult.getDBRespone();
                    GetResponeMap(DBRespone, DBParamsValuesMap);
        ...
        if (macdepunit != null) {
            ...
            AddHeaderByRequestContentType(header, requestcontenttype);
    ...
    private Object GetRadomValue(String Value) {
        ...
        List<Variables> variablesList = variablesService.listAll();
        for (Variables variables : variablesList) {
            if (variables.getVariablesname().equalsIgnoreCase(Value)) {
