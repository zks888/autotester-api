...
import com.zks888.api.dto.PerformanceCaseStatis;
import com.zks888.api.dto.PerformanceSlaverStatics;
...
public class ApicasesReportPerformanceController {
    ...
    public Result search(@RequestBody final Map<String, Object> param) {
        ...
        if (routeperformancereport != null) {
            tableName = routeperformancereport.getTablename();
        } else {
            tableName = "apicases_report_performance";
        }
        PageHelper.startPage(page, size);
        List<ApicasesReportPerformance> list = apicasesReportPerformanceService.finddynamicresult(planid, batchname, tableName);
    ...
    public Result findApicasereportWithNameandStatus(@RequestBody final Map<String, Object> param) {
        ...
        PageHelper.startPage(page, size);
        List<ApicasesReportPerformance> list = apicasesReportPerformanceService.finddynamicresultbystatus(executeplanid, batchname, tableName, status);
